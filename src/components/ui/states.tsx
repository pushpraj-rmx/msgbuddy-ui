...
export function LoadingState({ label = "Loading..." }: { label?: string }) {
  return (
    <div className="flex items-center gap-2.5 rounded-box border border-base-300 bg-base-200 px-4 py-3 text-[13px] text-base-content/65">
...
export function EmptyState({
  ...
  return (
    <div className="op-grain relative flex flex-col items-center justify-center rounded-box border border-dashed border-base-300 bg-base-200 px-6 py-12 text-center">
      ...
      {description ? (
        <p className="mt-1.5 max-w-sm text-[12px] text-base-content/55">{description}</p>
      ) : null}
...
export function ErrorState({
  ...
  return (
    <div className="rounded-box border-l-2 border border-error/30 border-l-error bg-base-200 px-4 py-3">
      ...
      <p className="text-[13px] font-medium text-base-content">{message}</p>
      {suggestion ? (
        <p className="mt-1 text-[12px] text-base-content/55">{suggestion}</p>
      ) : null}
